...
import de.visualdigits.kaisstream.domain.model.geodata.ShipCategory
    ...
    return drawWithCache {
        ...
        onDrawWithContent {
            ...
            vessels
                ...
                .forEach { vessel ->
                    val offset = vessel.extrapolatedPosition.calculateRadarOffset(
                        other = location,
            ...
            val offset = selectedVessel.extrapolatedPosition.calculateRadarOffset(
                other = location,
                radarRadiusPx = radius,
                maxRadarDistanceMeters = currentRadarRadius,
                center = drawCenter
...
private fun ContentDrawScope.drawVessel(
    ...
    if (vessel.sog > 0.5) {
        withTransform({
            ...
            rotate(
                degrees = vessel.heading.toFloat() - 180.0f,
                pivot = offset
            )
        }) {
            drawImage(
