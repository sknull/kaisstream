package de.visualdigits.kaisstream.presentation.page
...
import de.visualdigits.kaisstream.presentation.style.MyShapes
import de.visualdigits.kaisstream.presentation.style.TextColor
import de.visualdigits.kaisstream.presentation.style.colorScheme
import de.visualdigits.kaisstream.presentation.style.gap
import de.visualdigits.kaisstream.presentation.style.typography
...
//            screenWidth > 1500.dp -> 1.5f
        ...
        MaterialTheme(
            ...
            LaunchedEffect(Unit) {
                ...
                viewModel.onAction(KAisStreamAction.UpdateMaxImageSize(state.settings, max(wPx, hPx)))
            }
